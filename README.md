...
1. Grant permission for the app to access your location when prompted.
2. The app will display the current weather information for your area.
3. To search for weather data by city name, enter the city name in the designated search bar and press Enter or click the search button.
4. The app will show the weather information based on the searched city.
